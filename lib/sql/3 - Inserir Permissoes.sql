...
INSERT INTO [dbo].[Permissao]
           ...
           ,[Atributos])
     VALUES
            ('Folha','Importação de arquivos da folha','','Folha','Arquivo','',@id,1,0,1,0,'')
		   ,('Lote','Importação de arquivos em lote','','Lote','Arquivo','',@id,2,0,1,0,'')
		   ,('Movimento','Exportação de arquivos de movimento','','Movimento','Arquivo','',@id,3,0,1,0,'')
		   ,('Retorno','Exportação de arquivos de retorno','','Retorno','Arquivo','',@id,4,0,1,0,'')
GO
...
INSERT INTO [dbo].[Permissao]
           ...
           ,[Atributos])
     VALUES
            ('Contratos','Relatórios de contratos','','Contrato','Relatorio','',@id,1,0,1,0,'')
		   ,('Servidores','Relatórios de servidores','','Servidor','Relatorio','',@id,2,0,1,0,'')
GO
...
INSERT INTO [dbo].[Permissao]
           ...
           ,[Atributos])
     VALUES
            ('Criar acesso','Criar novo acesso de usuário','','Criar','Usuario','',@id,1,0,0,1,'id')
		   ,('Detalhar acesso','Detalhar acesso do usuário','','Detalhar','Usuario','',@id,2,0,0,1,'id')
		   ,('Editar acesso','Editar acesso do usuário','','Editar','Usuario','',@id,3,0,0,1,'id')
		   ,('Excluir acesso','Excluir acesso do usuário','','Excluir','Usuario','',@id,4,0,0,1,'id')
GO
...
INSERT INTO [dbo].[Permissao]
           ...
           ,[Atributos])
     VALUES
            ('Criar consignação','Criar nova consignação','','Criar','Consignacao','',@id,1,0,0,1,'id')
		   ,('Detalhar consignação','Detalhar consignação','','Detalhar','Consignacao','',@id,2,0,0,1,'id')
		   ,('Editar consignação','Editar consignação','','Editar','Consignacao','',@id,3,0,0,1,'id')
		   ,('Excluir consignação','Excluir consignação','','Excluir','Consignacao','',@id,4,0,0,1,'id')
GO
...
INSERT INTO [dbo].[Permissao]
           ...
           ,[Atributos])
     VALUES
            ('Criar consignatária','Criar nova consignatária','','Criar','Consignataria','',@id,1,0,0,1,'id')
		   ,('Detalhar consignatária','Detalhar consignatária','','Detalhar','Consignataria','',@id,2,0,0,1,'id')
		   ,('Editar consignatária','Editar consignatária','','Editar','Consignataria','',@id,3,0,0,1,'id')
		   ,('Excluir consignatária','Excluir consignatária','','Excluir','Consignataria','',@id,4,0,0,1,'id')
GO
