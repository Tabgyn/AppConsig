...
namespace AppConsig.Web.Gestor.DI.Autofac.Modules
{
        ...
        : global::Autofac.Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            TimeSpan absoluteCacheExpiration = TimeSpan.FromMinutes(60);
            bool visibilityAffectsDescendants = true;
            bool useTitleIfDescriptionNotProvided = true;
            bool securityTrimmingEnabled = false;
            string[] includeAssembliesForScan = new string[] { "AppConsig.Web.Gestor" };
